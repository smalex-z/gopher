...
interface PaginatedTableProps<T> {
  ...
  /** Replace the default header row styling — useful when callers want a tinted/sticky header. */
...
export function PaginatedTable<T>({
  ...
  const headerRowCls = headerRowClassName ?? 'border-b border-gray-100'
  ...
  return (
    <div>
      ...
      {rows.length === 0 ? (
        emptyState ?? <p className="text-sm text-gray-400 py-4">No entries.</p>
      ) : (
        <>
